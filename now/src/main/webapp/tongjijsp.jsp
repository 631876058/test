								...
								<div class="page-header">
									...
									<ul class="breadcrumb">
										<li>
											...
											<a href="index.html">我要中奖</a>
										</li>
										<li>
											<a href="#">往期彩票信息</a>
										</li>
									</ul>
									<div class="description">数据不断更新中，一定要关注哦！！</div>
								</div>
							</div>
							<div class="col-md-12">
								...
								<div class="box border pink">
									<div class="box-title">
										<h4><i class="fa fa-bar-chart-o fa-fw"></i>统计信息如下:</h4>
										<div class="tools">
									...
									<div class="box-body">
										<table id="nowdata" class="table table-bordered">
											<thead>
		...
		$.post(
				...
				function(d){
					...
					for(var i = 0;i<d.length;i++){
						...
						html += "<td>"+d[i].qs+"</td>";
						html += "<td>"+d[i].hz+"</td>";
						for(var j = 0;j<d[i].joh.length;j++){
							html += "<td>"+d[i].joh[j]+"</td>"
						}
						for(var k = 0;k<d[i].sxz.length;k++){
							html += "<td>"+d[i].sxz[k]+"</td>"
						}
						html += "<td></td>";
						html += "<td></td>";
						html += "<td></td>";
